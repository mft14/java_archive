...
public class BearbeitenEintrag extends JDialog {
	...
	private void ganzVor() {
		try {
			...
			ergebnisMenge.first();
			System.out.println("Ganz Vor - Datenbank: " + ergebnisMenge.first());
			datenLesen();
		}
		catch(Exception e) {
			JOptionPane.showMessageDialog(this, "Problem: \n" + e.toString());
	...
	private void ganzZurueck() {
		try {
			...
			ergebnisMenge.last();
			System.out.println("Ganz Zurück - Datenbank: " + ergebnisMenge.last());
			datenLesen();
		}
		catch(Exception e) {
			JOptionPane.showMessageDialog(this, "Problem: \n" + e.toString());
	...
	private void einenVor() {
		try {
			...
			if (ergebnisMenge.next())
				System.out.println("Nächste Datenbank");
				datenLesen();
		}
		catch(Exception e) {
			JOptionPane.showMessageDialog(this, "Problem: \n" + e.toString());
