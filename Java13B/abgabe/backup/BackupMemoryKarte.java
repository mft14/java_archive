...
//Sie erbt von Button
public class BackupMemoryKarte extends Button {
	...
	private BackupMemoryFeld spielfeld;
	...
	class KartenHandler implements EventHandler<ActionEvent>{
		...
		public void handle(ActionEvent arg0) {
			...
			if (umgedreht == false) {
				...
				spielfeld.karteOeffnen(BackupMemoryKarte.this);
			}
		}
	}
	...
	//der Konstruktor
	//er setzt die Bilder
	public BackupMemoryKarte(String vorne, int bildID, BackupMemoryFeld spielfeld) {
